...
final class mime extends object
{
     ...
     *           extension first. Be careful about not adding duplicate keys -
     *           PHP
     *           silently ignores duplicates. The following command can be used
     *           for
     *           checking for duplicates:
     *           grep "=> '" Extension.php | cut -d\' -f2 | sort | uniq -d
     *           application/octet-stream is generally used as fallback when no
     *           other
     *           MIME-type can be found, but the array does not contain a lot of
     *           such
     *           unknown extension. One entry exists, though, to allow detection
     *           of
     *           file extension for this MIME-type.
     *          
     * @var array
     */
    static $extensionToType = array(
     ...
     *
     * @param string $file
     *            Path to the file to get the type of
     *            
